 ...
 */
export function buildContextFromSession(session, options) {
    return {
 ...
 */
export async function handshakeWithSubAgent(mainContext, subAgentTask, subAgentCapabilities = ['code']) {
 ...
 */
function generateContextPrompt(session) {
 ...
 */
export function parseIncomingContext(message) {
 ...
 */
export function createEnrichedSpawnTask(originalTask, context) {
